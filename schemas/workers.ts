...
export const ListActionsParamSchema = z.object({
  projectKey: z.string().optional().describe("The project key for which you want to retrieve available actions")
});

export const WorkerSettingsType = z.object({
  description: z.string().optional().describe("Describe what this worker does"),
